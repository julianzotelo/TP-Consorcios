...
BEGIN TRY
    ...
    CREATE TABLE Consorcios (
        ID_consorcio INT NOT NULL PRIMARY KEY,
	...
	CREATE TABLE TipoDetalleFinanciero (
		ID_tipo_detalle INT NOT NULL PRIMARY KEY,
    ...
    CREATE TABLE Estado_financiero (
        ID_estado_financiero INT NOT NULL PRIMARY KEY,
        ID_consorcio INT NOT NULL,
        periodo CHAR(7),
    ...
    ID_detalle_estado INT NOT NULL PRIMARY KEY,
	...
	CREATE TABLE TipoGasto (
		ID_tipo_gasto INT NOT NULL PRIMARY KEY,
		nombre VARCHAR(50) NOT NULL,
		descripcion VARCHAR(200)
	);
	...
	CREATE TABLE Detalle_Gasto (
		ID_detalle_gasto INT NOT NULL PRIMARY KEY,
		...
		CONSTRAINT FK_DetalleGasto_Gastos FOREIGN KEY (ID_gasto)
			...
			ON DELETE CASCADE
			ON UPDATE CASCADE,
		CONSTRAINT FK_DetalleGasto_Categoria FOREIGN KEY (ID_categoria)
    ...
    CREATE TABLE Unidad_funcional (
        ID_unidad_funcional INT NOT NULL PRIMARY KEY,
        ID_consorcio INT NOT NULL,
    ...
    fecha_desde DATE,--por un periodo puede haber un inquilino en una unidad y luego otro o se puede mudar el propietario
    fecha_hasta DATE,
    PRIMARY KEY (ID_unidad_funcional, DNI, rol),
    FOREIGN KEY (ID_unidad_funcional) REFERENCES Unidad_funcional(ID_unidad_funcional),
    ...
    CREATE TABLE Cochera (
        ID_Cochera INT NOT NULL PRIMARY KEY,
        ID_unidad_funcional INT NOT NULL,
        m2 DECIMAL(6,2),
        CONSTRAINT FK_Cochera_UnidadFuncional FOREIGN KEY (ID_unidad_funcional)
    ...
    CREATE TABLE Baulera (
        ID_Baulera INT NOT NULL PRIMARY KEY,
        ID_unidad_funcional INT NOT NULL,
        m2 DECIMAL(6,2),
        CONSTRAINT FK_Baulera_UnidadFuncional FOREIGN KEY (ID_unidad_funcional)
            REFERENCES Unidad_funcional(ID_unidad_funcional)
            ON DELETE CASCADE
            ON UPDATE CASCADE
    );
    ...
    CREATE TABLE Expensas (
        ID_expensas INT NOT NULL PRIMARY KEY,
        ID_unidad_funcional INT NOT NULL,
        periodo CHAR(7),
        monto_total DECIMAL(10,2),
        estado VARCHAR(20),
        fecha_vencimiento DATE,
        CONSTRAINT FK_Expensas_UnidadFuncional FOREIGN KEY (ID_unidad_funcional)
            REFERENCES Unidad_funcional(ID_unidad_funcional)
            ON DELETE CASCADE
            ON UPDATE CASCADE
    );
    ...
    CREATE TABLE Estado_cuenta_prorrateo (
        ID_estado_de_cuenta INT NOT NULL PRIMARY KEY,
        ID_unidad_funcional INT NOT NULL,
        periodo CHAR(7),
        saldo_anterior DECIMAL(10,2),
        ...
        CONSTRAINT FK_EstadoCuenta_UnidadFuncional FOREIGN KEY (ID_unidad_funcional)
            REFERENCES Unidad_funcional(ID_unidad_funcional)
            ON DELETE CASCADE
            ON UPDATE CASCADE
    );
    ...
    CREATE TABLE Detalles_expensas (
        ID_detalle_expensas INT NOT NULL PRIMARY KEY,
